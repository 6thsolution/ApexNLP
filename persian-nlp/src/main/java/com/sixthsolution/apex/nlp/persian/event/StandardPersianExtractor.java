...
public class StandardPersianExtractor implements PersianExtractor{
    ...
    public void extract(PersianEventBuilder builder, LocalDateTime source, ChunkedPart chunkedPart) {
...
//                sde.extract(new PersianEventBuilder(), LocalDateTime.now(), cp);
...
//        }
//        StandardPersianExtractor sde = new StandardPersianExtractor();
//        sde.extract(new PersianEventBuilder(), LocalDateTime.now(), cp2);
//        if (forward) {
...
//            sde2.extract(new PersianEventBuilder(), LocalDateTime.now(), cp2);
//            start = sde.date;
//            end = sde2.date;
