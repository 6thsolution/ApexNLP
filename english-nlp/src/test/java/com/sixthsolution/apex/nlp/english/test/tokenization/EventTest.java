...
public class EventTest {
    ...
    public void test_date_extraction() {
        ...
        assertEvent("15/apr/2012").start("2012/04/15 " + check_zero(String.valueOf(hour)) + ":" + check_zero(String.valueOf(min))).end("2012/04/15 " + check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
        assertEvent("2017/04/10").start("2017/04/10 " + check_zero(String.valueOf(hour)) + ":" + check_zero(String.valueOf(min))).end("2017/04/10 " + check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
...
//limited
        ...
        assertEvent("till 2017/04/10").end("2017/04/10 " + check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
        assertEvent("until 15/apr/2012").end("2012/04/15 " + check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
        ...
        assertEvent("december 2012").startDate("2012" + "-12-" +check_zero(String.valueOf(day))).endDate("2012" + "-12-" +check_zero(String.valueOf(day)));
        ...
        assertEvent("sunday").startDate(year + "-08-06");
        assertEvent("monday").startDate(year + "-08-07");
...
//relative
        ...
        assertEvent("next monday").startDate(year + "-08-07");
        assertEvent("4 monday from_today").startDate(year + "-08-28");
        assertEvent("next may").startDate(year + 1 + "-05-" + check_zero(String.valueOf(day)));
        assertEvent("next aug").startDate(year +1+ "-08-" + check_zero(String.valueOf(day)));
        assertEvent("next jan").startDate(year + 1 + "-01-" + check_zero(String.valueOf(day)));
        assertEvent("next july 9").startDate(year + "-07-09");
        assertEvent("next week third day").startDate(year + "-08-09");
        assertEvent("next year july 9th day").startDate(year + 1 + "-07-09");
        //global date
        assertEvent("day after tomorrow").startDate(year + "-08-" + check_zero(String.valueOf(day + 2)));
        assertEvent("one week before 2018/02/14").startDate("2018-02-07");

        //forever
        assertEvent("every 2 days till tomorrow").startDate(year + "-" + check_zero(String.valueOf(month)) + "-" +check_zero(String.valueOf(day))).checkRecurrence("daily,2,false,2017-08-02");
        assertEvent("every 2 weeks").startDate(year + "-" + check_zero(String.valueOf(month)) + "-" +check_zero(String.valueOf(day))).checkRecurrence("weekly,2,false,2017-08-01");
    ...
    public void test_full_sentence() {
        ...
        assertEvent("12/09 Meet John at Mall from 9:30 to 12:00")
                ...
                .startTime("09:30")
                .endTime("12:00");
//        assertEvent("Meet John on wednesday at Mall")
//                .location("Mall")
//                .start(year + "/" + check_zero(String.valueOf(month)) + "/" + check_zero(String.valueOf(day)) + " " + check_zero(String.valueOf(hour)) + ":" + check_zero(String.valueOf(min)))
//                .end(year + "/" + check_zero(String.valueOf(month)) + "/" + check_zero(String.valueOf(day)) + " " + check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
        ...
        assertEvent("Mission Trip at Jakarta on Nov 13-17 calendar Church")
                ...
                .endTime(check_zero(String.valueOf((hour + 1) % 24)) + ":" + check_zero(String.valueOf(min)));
        ...
        assertEvent("meeting with Tom for two hours after noon")
                .start("2017/08/01 12:00").end("2017/08/01 14:00");
    }
